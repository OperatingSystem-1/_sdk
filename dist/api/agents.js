...
export class AgentsAPI {
    ...
    async hire(officeId, req) {
        // CLA-904: route create/hire through the dashboard so dashboard tables
        // (bots, virtual_office_bots) get written atomically with OM's employees row.
        // All other agent ops (list/get/update/fire/etc.) stay on OM.
        return this.transport.dashboardRequest('POST', `/api/offices/${officeId}/hire`, { body: req });
    }
    async list(officeId) {
